            ...
            <div className="footer-container">
                <div className="footer-top">
                    ...
                    <div className="footer-col">
                        <h4>Courses</h4>
                        <ul>
                            <li><a href="/course#courses">Specializations</a></li>
                            <li><a href="/course#ai-courses">Cyber AI Track</a></li>
                            <li><a href="/course#courses">Web Dev Track</a></li>
                            <li><a href="/course#courses">CEH Prep</a></li>
                            <li><a href="/course#enroll">Pricing</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-col">
                        <h4>Company</h4>
                        <ul>
                            <li><Link to="/mentorship">About</Link></li>
                            <li><a href="/#career">Careers</a></li>
                            <li><a href="/#enquiry">Contact</a></li>
                            <li><a href="/course#partners">Partners</a></li>
                        </ul>
                    </div>
                </div>
